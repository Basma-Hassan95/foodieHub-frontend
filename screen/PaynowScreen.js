...
const PaynowScreen = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await fetch('https://foodiehub-backend-production.up.railway.app/savepayment', {
        method: 'POST',
        headers: {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.totalPrice}>Total Price: PKR {orderData.totalAmount}</Text>
